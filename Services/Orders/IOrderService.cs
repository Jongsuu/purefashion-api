...
namespace PureFashion.Services.Order
{
    public interface IOrderService
    {
        ...
        public Task<dtoActionResponse<dtoOrderEntity>> GetOrderDetail(string orderId, string userId);
        public Task<dtoActionResponse<bool>> CreateOrder(List<dtoOrderProduct> products, string userId);
        public Task<dtoActionResponse<bool>> CreateOrderFromCart(string userId);
